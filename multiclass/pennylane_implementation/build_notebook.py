"""One-off script that assembles Parallel_QML_Checkerboard4L_PennyLane.ipynb via nbformat."""
...
md(r"""# Quantum Machine Learning with a TwoLocal Variational Classifier -- 4-Label Checkerboard (PennyLane)
...
MAXITER = 100      # SPSA iterations (the shipped results used ~400; Method 2 is
...
code(r"""# os.path.abspath collapses the ".." segment against cwd -- this project's
...
code(r"""print(f"Dataset: checkerboard-4L-4Q / dataset{DATASET_NUM}    Mode: {MODE}    Framework: PennyLane\n")
...
with open("Parallel_QML_Checkerboard4L_PennyLane.ipynb", "w", encoding="utf-8") as f:
    nbf.write(nb, f)
